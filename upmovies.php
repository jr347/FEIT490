  ...
  <div class="col-lg-6">
    <div class="input-group">
      <span class="input-group-btn">
        <button class="btn btn-default" onclick="successfulAdd()" type="button">Add</button>
      </span>
      <input type="text" id="addartist" name="addartist" class="form-control" placeholder="Search for Artist">
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
</div><!-- /.row -->
</br><span id="succ" name="succ"></span>
